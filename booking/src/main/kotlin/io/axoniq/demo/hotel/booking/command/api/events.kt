...
// Room
data class RoomAddedEvent(val roomNumber: Int, val roomId: UUID, val roomDescription: String)
...
data class RoomStatusChangedEvent(val roomNumber: Int, val roomStatus: RoomStatus)
